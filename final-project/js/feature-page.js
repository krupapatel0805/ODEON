...
`
    ...
    <div class="movie-details">
        ...
        <p class="movie-desc">${dataObject.movieDesc}</p>
...
function showSeating() {
    for (let i = 0; i < 12; i++) {
        ...
        if(i%4 == 0){
            ...
            `
        <span>
            <a href="payment-page.html" class="showClick" data-showTimeVal=${i} data-time="11:00 am" disabled=${check}>
                11:00 am
            </a>
        </span>            
        `
            ...
            `
        <span>
            <a href="payment-page.html" class="showClick" data-showTimeVal=${i} data-time="3:00 pm" disabled=${check}>
                3:00 pm
            </a>
        </span>            
        `
            ...
            `
        <span>
            <a href="payment-page.html" class="showClick" data-showTimeVal=${i} data-time="7:00 pm" disabled=${check}>
                7:00 pm
            </a>
        </span>            
        `
            ...
            `
        <span>
            <a href="" class="showClick" data-showTimeVal=${i} data-time="11:00 pm" disabled=${check}>
                11:00 pm
            </a>
        </span>            
        `
...
const shows = document.querySelectorAll('.showClick');
    ...
    for (i=0;i<shows.length;i++){
        ...
        if (showTime <= 3){
            showDate = 'Friday (27-01-2023)';
        } else if(showTime >=4 && showTime <= 7) {
            showDate = 'Saturday (28-01-2023)';
        } else if(showTime >=8 && showTime <= 11) {
            showDate = 'Sunday (29-01-2023)';
        }
